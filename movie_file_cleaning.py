...
dir_to_scan = "/Users/keitabroadwater/data/netflix/data"  # Change to your directory
...
movie_titles = pd.read_csv('/Users/keitabroadwater/data/netflix/movie_titles.csv', header = None, names = ['movie_id', 'year', 'title'], usecols=[0,1,2],encoding = "ISO-8859-1")
